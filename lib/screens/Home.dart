...
class _HomePageState extends State<HomePage> {
  ...
  final List<CategoryData> categoryList=[
    ...
    CategoryData(categoryImage: "assets/category/pot3.png", categoryName: "Pots"),
    CategoryData(categoryImage: "assets/category/f1.png", categoryName: "Fertilizers"),
                        ...
                        onTap: (){
                          switch (index){
                            case 0:
                              ...
                              break;
                            case 1:
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>Products(mainCategory: "tool",client: GraphQLClient(link: httpLink,cache: GraphQLCache()),)));
                              break;
                            case 2:
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>Products(mainCategory: "pot",client: GraphQLClient(link: httpLink,cache: GraphQLCache()),)));
                              break;
                            case 3:
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>Products(mainCategory: "fertilizer",client: GraphQLClient(link: httpLink,cache: GraphQLCache()),)));
                              break;
